...
//Because it has a closure placed inside of myFunction so it can access its variables.
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(list){
    ...
    list.forEach(element => {
      newList.push("name: " + element.animal_name + ", scientific: " + element.scientific_name);
    });
    return newList;
  }
  ...
  */
  ...
  function lowerCaseNames(list){
    let newList = list.map(name => name.animal_name.toLowerCase());
    return newList;
...
let stats = {
 ...
 let cuboidTwo = new CuboidMaker(stats);
